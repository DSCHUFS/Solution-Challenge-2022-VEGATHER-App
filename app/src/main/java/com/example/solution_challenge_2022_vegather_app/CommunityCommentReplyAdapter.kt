...
class CommunityCommentReplyAdapter(private val binding : CommentReplyRecyclerBinding,
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val binding = (holder as CommunityCommentReplyAdapter.CommentReplyViewHolder).binding
