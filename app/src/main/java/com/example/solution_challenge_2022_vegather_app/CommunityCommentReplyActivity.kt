...
class CommunityCommentReplyActivity : AppCompatActivity() {
    ...
    private fun getData(){
        ...
        documentName = intent.getStringExtra("documentName").toString()
    ...
    private fun getReplyComments(){
        val commentAdapter= CommunityCommentReplyAdapter(
            CommentReplyRecyclerBinding.inflate(layoutInflater),
            documentName,
            user.email.toString(),
